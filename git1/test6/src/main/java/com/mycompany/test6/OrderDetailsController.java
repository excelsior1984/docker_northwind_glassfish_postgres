...
public class OrderDetailsController implements Serializable {
    ...
    @EJB
    private com.mycompany.test6.OrderDetailsFacade ejbFacade;
    ...
    public OrderDetails getSelected() {
        if (current == null) {
            ...
            current.setOrderDetailsPK(new com.mycompany.test6.OrderDetailsPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getOrderDetailsPK().setProductId(current.getProducts().getProductId());
            current.getOrderDetailsPK().setOrderId(current.getOrders().getOrderId());
    ...
    public OrderDetails getOrderDetails(com.mycompany.test6.OrderDetailsPK id) {
    ...
    public static class OrderDetailsControllerConverter implements Converter {
        ...
        com.mycompany.test6.OrderDetailsPK getKey(String value) {
            com.mycompany.test6.OrderDetailsPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.test6.OrderDetailsPK();
            key.setOrderId(Short.parseShort(values[0]));
            key.setProductId(Short.parseShort(values[1]));
            return key;
        }

        String getStringKey(com.mycompany.test6.OrderDetailsPK value) {
